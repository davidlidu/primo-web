...
export const metadata: Metadata = {
  ...
  alternates: getAlternates("/prestamos-inversionistas-dscr"),
  openGraph: {
    title: "Préstamos DSCR para Inversionistas | Financiamiento de Propiedades | Primo Team",
        ...
        <section className="py-20 bg-gradient-to-r from-[#FFBA00] to-[#F36C37]">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button href="/contacto" variant="outline" size="lg" className="border-white text-white hover:bg-white hover:text-[#241C4F]">
                Habla con un Asesor
              </Button>
            </div>
          </div>
