...
export const metadata: Metadata = {
  ...
  alternates: getAlternates("/opciones-de-prestamo"),
  openGraph: {
    title: "Opciones de Préstamo | Primo Team",
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {CONFORMING_PRODUCTS.map((product, index) => (
                ...
                >
                  ...
                  <Button href="/contacto" variant="ghost" size="sm" className="group-hover:text-[#F36C37]">
                    Más Información →
                  </Button>
                </div>
              ))}
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {NON_QM_PRODUCTS.map((product, index) => (
                ...
                >
                  ...
                  <Button href="/contacto" variant="outline" size="sm" className="w-full justify-center">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-10 text-center">
              <p className="text-white/60 text-sm bg-white/5 rounded-xl px-6 py-4 inline-block">
                ...
                <a href="/contacto" className="text-[#FFBA00] hover:text-[#FFBA00]/80 underline transition-colors">
                  Contáctanos
                </a>{" "}
